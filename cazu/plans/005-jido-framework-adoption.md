...
7. `CAZU-007` Provider abstraction v1 (OpenAI + Anthropic or Gemini).
...
Transformar este plano em execução direta:
- roadmap semanal com marcos e donos,
- checklist de PR por sprint,
- sequência de commits sugerida (ordem para minimizar risco e retrabalho),
- matriz de risco por tool (low-risk auto-approve vs high-risk confirmação).